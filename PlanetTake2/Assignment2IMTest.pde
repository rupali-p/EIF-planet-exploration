...
void draw() {
  ...
  push();
  translate(-200, 0, -200);
  planet1.CreatePlanetMain(monthtemps1, monthsolars1, phase, avgTemp, drawDayCount);
  planet1.CreatePlanetAtmosphere(monthrains1, phase, drawDayCount);
  pop();
  push();
  translate(200, 0, 0);
  //  planet1.CreatePlanetAtmosphere(monthrains4, phase);
  planet2.CreatePlanetMain(monthtemps2, monthsolars2, phase, avgTemp, drawDayCount);
  planet2.CreatePlanetAtmosphere(monthrains2, phase, drawDayCount);  
  pop();
  push();
  translate(-300, 0, 0);
  planet3.CreatePlanetMain(monthtemps3, monthsolars3, phase, avgTemp, drawDayCount);
  planet3.CreatePlanetAtmosphere(monthrains3, phase, drawDayCount);  
  pop();
  push();
  translate(300, 0, 300);
  planet4.CreatePlanetMain(monthtemps4, monthsolars4, phase, avgTemp, drawDayCount);
  planet4.CreatePlanetAtmosphere(monthrains4, phase, drawDayCount);
  pop();
